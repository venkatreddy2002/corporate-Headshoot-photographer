document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mobileMenuClose) {
        ...
        // 4.1 Responsive Reset on Window Resize
    // Close mobile drawer when transitioning to desktop view (>=1024px)
    ...
    // 3.1 Mobile Drawer Accordion Toggle (Closed by default)
    ...
    accordionTriggers.forEach(trigger => {
        ...
        trigger.classList.add('text-slate-900', 'dark:text-white');
        if (icon) {
        ...
        trigger.addEventListener('click', () => {
            if (content) {
                ...
                if (isHidden) {
                    ...
                    trigger.classList.add('text-primary');
                    trigger.classList.remove('text-slate-900', 'dark:text-white');
                }
                if (icon) {
...
window.switchSection = function (sectionId) {
    ...
    if (contentArea && template) {
        ...
        const titles = {
            ...
            'orders': isUserDashboard ? 'Orders' : 'Booking History',
            'saved': isUserDashboard ? 'Saved' : 'Saved Services',
            'messages': isUserDashboard ? 'Messages' : 'Communications',
        ...
        const subtitles = {
            ...
            'history': 'Detailed session logs and service history for your creative work.',
